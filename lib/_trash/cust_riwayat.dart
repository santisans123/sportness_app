...
class CustomerRiwayat extends StatefulWidget {
  final String title;
  const CustomerRiwayat({Key? key, required this.title}) : super(key: key);

  @override
  _CustomerRiwayat createState() => _CustomerRiwayat();
}

class _CustomerRiwayat extends State<CustomerRiwayat> {
  double width = 0.0;
  double height = 0.0;

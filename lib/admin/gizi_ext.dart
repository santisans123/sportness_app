...
class adminGiziExt extends StatefulWidget {
  const adminGiziExt({Key? key}) : super(key: key);
  static Route<void> route() {
    return MaterialPageRoute(builder: (context) => adminGiziExt());
  }

  @override
  State<StatefulWidget> createState() {
    return _adminGiziExt();
  }
}

class _adminGiziExt extends State<adminGiziExt> {

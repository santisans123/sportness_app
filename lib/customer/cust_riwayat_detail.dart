...
class customerRiwayatDetail extends StatefulWidget {
  @override
  State<customerRiwayatDetail> createState() => _customerRiwayatDetail();
}

class _customerRiwayatDetail extends State<customerRiwayatDetail> {
  onGoBack(dynamic value) {
    setState(() {
      _customerRiwayatDetail();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final datacart = supabase
        .from('cart')
        .select('id, jumlah, status, nutrishop_produk(id, nama,harga,img)')
        .in_('id', idcart);
